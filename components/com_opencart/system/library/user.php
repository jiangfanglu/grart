	...
	private $username;
  	...
  	public function __construct($registry) {
		...
		if(defined("DONT_SHOW_ADMIN_LOGIN") && DONT_SHOW_ADMIN_LOGIN=="1" && !isset($_SESSION['user_id'])){
			...
			{
				if($joomla_user->get('usertype')=="" && is_array($joomla_user->get('groups')))
				...
				elseif($joomla_user->get('username')!="" && ($joomla_user->get('usertype')=="Super Administrator" || $joomla_user->get('usertype')=="Administrator" || $joomla_user->get('usertype')=="deprecated" || in_array("6",$juser_groups) || in_array("7",$juser_groups) || in_array("8",$juser_groups)))
				{
