...
class ControllerCheckoutCart1 extends Controller {
	private $error = array();
	...
	public function index() {
    	...
    	if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/cart1.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/checkout/cart1.tpl';
			} else {
				$this->template = 'default/template/checkout/cart1.tpl';
			}
	...
	public function add() {
		...
		if ($product_info) {			
			...
			if (isset($this->request->post['option_ext'])) {
				$option = array_filter($this->request->post['option_ext']);
			} else {
				$option = array();	
			}
