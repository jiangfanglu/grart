...
class ControllerAccountOrder1 extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/order_list1.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/account/order_list1.tpl';
		} else {
			$this->template = 'default/template/account/order_list1.tpl';
		}
