...
class ControllerAccountReturn1 extends Controller { 
	private $error = array();
	...
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/return_list1.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/account/return_list1.tpl';
		} else {
			$this->template = 'default/template/account/return_list1.tpl';
		}
	...
	public function info() {
		...
		if ($return_info) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/error/not_found1.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/error/not_found1.tpl';
			} else {
				$this->template = 'default/template/error/not_found1.tpl';
			}
