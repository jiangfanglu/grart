...
class ControllerAccountTransaction1 extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/transaction1.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/account/transaction1.tpl';
		} else {
			$this->template = 'default/template/account/transaction1.tpl';
		}
