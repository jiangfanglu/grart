...
class ControllerAccountAddress1 extends Controller {
	private $error = array();
  	...
  	private function getList() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/address_list1.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/account/address_list1.tpl';
		} else {
			$this->template = 'default/template/account/address_list1.tpl';
		}
