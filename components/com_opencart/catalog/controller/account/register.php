  	...
  	public function index() {
		if ($this->customer->isLogged()) {
	  		//$this->redirect($this->url->link('account/account', '', 'SSL'));
                    $this->redirect('/index.php?option=com_sitemain&view=usermanager');
    	}
		...
		if (isset($this->request->post['firstname'])) {
			...
			$this->data['firstname'] = 'First Name';
		}

		if (isset($this->request->post['lastname'])) {
    		$this->data['lastname'] = $this->request->post['lastname'];
		} else {
			$this->data['lastname'] = 'Last Name';
		}
		...
		if (isset($this->request->post['confirm'])) {
			...
			$this->data['confirm'] = 'Retype Password';
		}
        ...
        private function sendRegistrationMail($name){
            ...
            $mailer->setSubject($this->language->get('email_title'));
            $mailer->setBody($body);
