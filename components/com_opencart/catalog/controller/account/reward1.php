...
class ControllerAccountReward1 extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/reward1.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/account/reward1.tpl';
		} else {
			$this->template = 'default/template/account/reward1.tpl';
		}
