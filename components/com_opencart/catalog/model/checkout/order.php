...
class ModelCheckoutOrder extends Model {	
	...
	public function confirm($order_id, $order_status_id, $comment = '', $notify = false) {
		...
		if ($order_info && !$order_info['order_status_id']) {
			...
			$template->data['link'] = $order_info['store_url'] . 'index.php?option=com_opencart&'.ITEM_ID.'route=account/order/info&order_id=' . $order_id;
			
			if ($order_download_query->num_rows) {
				$template->data['download'] = $order_info['store_url'] . 'index.php?option=com_opencart&'.ITEM_ID.'route=account/download';
			} else {
			...
			if ($order_info['customer_id']) {
				...
				$text .= $order_info['store_url'] . 'index.php?option=com_opencart&'.ITEM_ID.'route=account/order/info&order_id=' . $order_id . "\n\n";
			}
		
			if ($order_download_query->num_rows) {
				$text .= $language->get('text_new_download') . "\n";
				$text .= $order_info['store_url'] . 'index.php?option=com_opencart&'.ITEM_ID.'route=account/download' . "\n\n";
			}
		...
		if ($order_info && $order_info['order_status_id']) {
			...
			if ($notify) {
				...
				if ($order_info['customer_id']) {
					...
					$message .= $order_info['store_url'] . 'index.php?option=com_opencart&'.ITEM_ID.'route=account/order/info&order_id=' . $order_id . "\n\n";
				}
