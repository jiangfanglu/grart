...
<?php } ?>
<!--<?php if(defined("USE_CUSTOM_COLOR_TEMPLATE")&& USE_CUSTOM_COLOR_TEMPLATE=="1"){?>
	<?php require_once(DIR_SYSTEM."../catalog/view/theme/default/stylesheet/stylesheet.css.php");?>
<?php } else {?>
	<link rel="stylesheet" type="text/css" href="catalog/view/theme/default/stylesheet/stylesheet.css" />
<?php } ?>-->
<?php $document = JFactory::getDocument();?>
<?php foreach ($styles as $style) { ?>
<?php $document->addStyleSheet('components/com_opencart/'.$style['href']);?>
<?php } ?>
...
<?php $document->addScript('components/com_opencart/'.$script);?>
<?php } ?>
<!--[if IE 7]>
