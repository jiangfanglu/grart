...
<!--        <h2><?php echo $text_option; ?></h2>-->
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <b><?php echo $option['name']; ?>:</b><br />
          <?php foreach ($option['option_value'] as $option_value) { ?>
          <input type="radio" name="option_ext[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" id="option-value-<?php echo $option_value['product_option_value_id']; ?>" />
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <b><?php echo $option['name']; ?>:</b><br />
          <?php foreach ($option['option_value'] as $option_value) { ?>
          <input type="checkbox" name="option_ext[<?php echo $option['product_option_id']; ?>][]" value="<?php echo $option_value['product_option_value_id']; ?>" id="option-value-<?php echo $option_value['product_option_value_id']; ?>" />
          <label for="option-value-<?php echo $option_value['product_option_value_id']; ?>"><?php echo $option_value['name']; ?>
            <?php if ($option_value['price']) { ?>
            (<?php echo $option_value['price_prefix']; ?><?php echo $option_value['price']; ?>)
            <?php } ?>
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <?php } ?>
          <b><?php echo $option['name']; ?>:</b><br />
          <input type="text" name="option_ext[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option['option_value']; ?>" />
        </div>
        <br />
        <?php } ?>
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <?php } ?>
          <b><?php echo $option['name']; ?>:</b><br />
          <textarea name="option_ext[<?php echo $option['product_option_id']; ?>]" cols="40" rows="5"><?php echo $option['option_value']; ?></textarea>
        </div>
        <br />
        <?php } ?>
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <input type="hidden" name="option_ext[<?php echo $option['product_option_id']; ?>]" value="" />
        </div>
        <br />
        <?php } ?>
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <?php } ?>
          <b><?php echo $option['name']; ?>:</b><br />
          <input type="text" name="option_ext[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option['option_value']; ?>" class="date" />
        </div>
        <br />
        <?php } ?>
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <?php } ?>
          <b><?php echo $option['name']; ?>:</b><br />
          <input type="text" name="option_ext[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option['option_value']; ?>" class="datetime" />
        </div>
        <br />
        <?php } ?>
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <?php } ?>
          <b><?php echo $option['name']; ?>:</b><br />
          <input type="text" name="option_ext[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option['option_value']; ?>" class="time" />
        </div>
        <br />
        <?php } ?>
        <?php } ?>
      ...
      <div class="cart">
        <div><?php echo $text_qty; ?>
          <input type="text" name="quantity" size="2" value="<?php echo $minimum; ?>" style="width:50px!important;" />
          <input type="hidden" name="product_id" size="2" value="<?php echo $product_id; ?>" />
          &nbsp;<input type="button" value="<?php echo $button_cart; ?>" id="button-cart" class="button" />
<!--        </div>
        <div><span>&nbsp;&nbsp;&nbsp;<?php echo $text_or; ?>&nbsp;&nbsp;&nbsp;</span></div>
        <div>-->
                &nbsp;<input onclick="addToWishList('<?php echo $product_id; ?>');" type="button" value="<?php echo $button_wishlist; ?>" id="button-wishlist" class="button" />
<!--          <a onclick="addToCompare('<?php echo $product_id; ?>');"><?php echo $button_compare; ?></a>-->
   ...
   <div style="width:100%;">
       <div style="width:100%;font-style:italic;padding-bottom:5px;">More from this artist</div>
       <div class="divder_bg_dynamic" style="margin-bottom: 5px;">&nbsp;</div>
