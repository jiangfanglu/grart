<?php if ($addresses) { ?>
<label class="radio_top" for="shipping-address-existing"><input type="radio" name="shipping_address" value="existing" id="shipping-address-existing" checked="checked" />
<?php echo $text_address_existing; ?></label>
<label class="radio_bottom" for="shipping-address-new"><input type="radio" name="shipping_address" value="new" id="shipping-address-new" />
...
<div id="shipping-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
  ...
  <input type="text" name="city" value=""  />
   ...
   <label><span id="shipping-postcode-required" class="required">*</span> <?php echo $entry_postcode; ?></label>
...
<input class="button" type="button" value="<?php echo $button_continue; ?>" id="button-shipping-address" />
