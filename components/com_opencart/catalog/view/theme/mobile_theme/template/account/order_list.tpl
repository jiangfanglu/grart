  ...
  <div class="order-list">
    ...
    <div class="order-content">
      ...
      <div class="order-info">
		  <div class="left"><a class="button" href="<?php echo $order['href']; ?>"><?php echo $button_view; ?></a></div>
		  <div class="right"><a class="button" href="<?php echo $order['reorder']; ?>"><?php echo $button_reorder; ?></a></div>
	  </div>
    </div>
  </div>
  <?php } ?>
