		...
		if ($this->config->get('config_complete_status_id') == $data['order_status_id']) {
      	...
      	if ($data['notify']) {
			...
			if ($order_info['customer_id']) {
				...
				$message .= html_entity_decode($order_info['store_url'] . 'index.php?option=com_opencart&route=account/order/info&order_id=' . $order_id, ENT_QUOTES, 'UTF-8') . "\n\n";
			}
