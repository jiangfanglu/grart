...
class ControllerCommonHome extends Controller {   
	public function index() {
		...
		//check wrong db info in jcart options
		if(isset($_SESSION["wrong_db_info"]) && $_SESSION["wrong_db_info"]=="yes"){
			$this->data['error_install'] = $this->language->get('error_dbinfo_jcart');
		}
