...
function MakeApiRequest() {
  ...
  xmlHttp.open("GET", sitebase_url+"administrator/components/com_facebookall/helpers/detectapi.php?apikey=" + apikey +"&apisecret="+apisecret+"&api_request="+api_request, true);
  xmlHttp.send(null);
}