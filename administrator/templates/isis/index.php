...
<head>
	...
	<jdoc:include type="head" />
         <link rel="stylesheet" href="/administrator/templates/isis/css/teresa.css" type="text/css" />
	<?php
	// Template color
...
<!--             <script src="/media/system/js/mootools-core.js" type="text/javascript"></script>-->
              <script src="/administrator/templates/isis/js/js.js" type="text/javascript"></script>
</head>
