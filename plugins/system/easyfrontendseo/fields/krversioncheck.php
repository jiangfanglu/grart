...
class JFormFieldKRVersionCheck extends JFormField
{
    ...
    protected function getInput()
    {
        ...
        if(!empty($version_check_enabled))
        {
            ...
            {
                $field_value = '<div style="border: 1px solid #DD87A2; border-radius: 2px; padding: 5px; background-color: #F9CAD9; font-size: 120%; margin: 4px 0;">'.JTEXT::sprintf('KR_VERSION_CHECK_NEWUPDATEAVAILABLE', $version_check['version_latest'], $version_check['url'], $version_check['name']).'</div>';
            }
